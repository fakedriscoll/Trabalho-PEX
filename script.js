  const allQuestions = [
    {
      ...
      answers: ["Firewall", "Engenharia social", "Backup", "VPN"],
      correct: 1,
      difficulty: "fácil"
    },
    {
    ...
    },
    {
      ...
      answers: ["Apagar arquivos", "Corrigir falhas de segurança", "Deixar mais lento", "Mudar o design"],
      correct: 1,
      difficulty: "fácil" 
    },
    {
    ...
    },
    {
      ...
      answers: ["Bloquear acessos indesejados", "Salvar senhas", "Melhorar o Wi-Fi", "Apagar vírus"],
      correct: 0,
      difficulty: "fácil"
    },
    {
    ...
    },
    {
      ...
      answers: ["Phishing", "Ransomware", "Funcionário mal-intencionado", "Ataque DDoS"],
      correct: 2,
      difficulty: "médio"
    },
    {
    ...
    },
    {
      ...
      answers: ["Cópia de backups", "Falsificação de identidade digital", "Atualização forçada", "Abertura de portas no firewall"],
      correct: 1,
      difficulty: "fácil" 
    },
    {
    ...
    },
    {
      ...
      answers: ["http://", "https://", "domínio .xyz", "popup de sorteio"],
      correct: 1,
      difficulty: "fácil"
    },
    {
      question: "Qual é a principal função de um antivírus?",
      answers: ["Melhorar o desempenho do computador", "Bloquear acessos não autorizados à rede", "Detectar, prevenir e remover malwares", "Organizar arquivos e pastas do sistema"],
      correct: 2,
      difficulty: "difícil"
    },
    {
    ...
    },
    {
      ...
      answers: ["Apenas por meio de downloads de programas maliciosos", "Por e-mails de phishing, downloads inseguros e dispositivos infectados", "Exclusivamente por redes Wi-Fi públicas", "Através de arquivos de texto infectados enviados por mensagens"],
      correct: 1,
      difficulty: "difícil"
    },
    {
    ...
    },
    {
      ...
      answers: ["Virtual Private Network", "Visual Protection Network", "Video Processing Net", "Voice Protocol Node"],
      correct: 0,
      difficulty: "médio"
    },
    {
    ...
    },
    {
      ...
      answers: ["É mais bonito", "É difícil de lembrar", "Um vazamento afeta todos", "Requer internet rápida"],
      correct: 2,
      difficulty: "médio"
    },
    {
    ...
    },
    {
      ...
      answers: ["Phishing em massa", "Phishing direcionado", "Um antivírus", "Spam comum"],
      correct: 1,
      difficulty: "difícil"
    },
    {
    ...
    },
    {
      ...
      answers: ["Clicar em spam", "Atualizar sistema", "Baixar apps piratas", "Compartilhar dados bancários"],
      correct: 1,
      difficulty: "médio"
    },
    {
    ...
    },
    {
      ...
      answers: ["Ransomware, trojan e spyware", "Firewall, cookie e 2FA", "Backup, HTTPS e VPN", "PDF, MP3 e DOC"],
      correct: 0,
      difficulty: "difícil"
    },
    {
    ...
    },
    {
      ...
      answers: ["Usar Wi-Fi público sem proteção", "Evitar compartilhar dados pessoais", "Desativar o antivírus", "Usar softwares piratas"],
      correct: 1,
      difficulty: "médio"
    },
    {
  ...
  function getQuestionsBySelectedDifficulty(level) {
    ...
    return shuffle(allQuestions.filter(q => q.difficulty === level)).slice(0, 50); // Filtra por dificuldade
  }
